                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            ...
                            <div class="box-content">
                                ...
                                <form class="form-horizontal" method="Get" action="ActionMatiereServlet">
                                    <fieldset>
                                        ...
                                        <c:if test="${requestScope.btnmodif != null }">
                                            ...
                                            <input type="hidden"  name="matiere" value="<c:out value="${requestScope.matiere.id}" escapeXml="true"></c:out>" required> 
                                        </c:if>
                                         <c:if test="${requestScope.btnmodif == null }">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="nom" value="<c:out value="${requestScope.matiere.nom}" escapeXml="true"></c:out>" > <!--id="inputError">
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align:middle;" class="center" ><c:out value="${matiere.nom}"></c:out></td>
                                                    ...
                                                    <td style="vertical-align:middle;" class="center">
                                                        <a class="btn btn-success" href="ActionMatiereServlet?id_event=zoom&id_m=<c:out value="${matiere.id}"></c:out>" >
                                                            <i class="halflings-icon white zoom-in"></i>  
                                                        </a>
                                                        <a class="btn btn-info" href="ActionMatiereServlet?id_event=edit&id_m=<c:out value="${matiere.id}"></c:out>" >
