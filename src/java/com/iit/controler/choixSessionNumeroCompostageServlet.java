 ...
 * @author SAMSUNG
 */
@WebServlet(name = "choixSessionNumeroCompostageServlet", urlPatterns = {"/choixSessionNumeroCompostageServlet"})
public class choixSessionNumeroCompostageServlet extends HttpServlet {
