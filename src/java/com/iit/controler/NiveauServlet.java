...
public class NiveauServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            NiveauDAO Niveau = new NiveauDAO();

            ArrayList<Niveau> niveauList = new ArrayList<Niveau>();

            niveauList = Niveau.listNiveau();

            request.setAttribute("niveauList", niveauList);

            RequestDispatcher rd = getServletContext().getRequestDispatcher("/niveau.jsp");
