            ...
            <div class="row-fluid">
                ...
                <div id="content" class="span10">
                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="halflings-icon edit"></i><span class="break"></span>Ajouter Session</h2>
                                <div class="box-icon">
                            ...
                            <div class="box-content">
                                ...
                                <form class="form-horizontal" method="Get" action="ActionSessionServlet">
                                    <fieldset>
                                        ...
                                        <c:if test="${requestScope.btnmodif != null }">
                                            ...
                                            <input type="hidden"  name="session" value="<c:out value="${requestScope.session.id}" escapeXml="true"></c:out>" required> 
                                        </c:if>
                                         <c:if test="${requestScope.btnmodif == null }">
								...
								<div class="controls">
								  <select id="selectError3" name="type">
									...
									<option value="Controle">Controle</option>
                                            ...
                                            <div class="control-group">
							  <label class="control-label" for="date01">Date de début</label>
							  <div class="controls">
								<input type="text"  name="date_d" class="input-xlarge datepicker"  id="date01" value="<c:out value="${requestScope.session.datedeb}" escapeXml="true"></c:out>">
							  </div>
							</div>
                                                          
                                                               <div class="control-group">
							  <label class="control-label" for="date02">Date de fin</label>
							  <div class="controls">
								<input type="text"  name="date_f" class="input-xlarge datepicker" id="date02" value="<c:out value="${requestScope.session.datefin}" escapeXml="true"></c:out>">
							  </div>
							</div>
                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="halflings-icon user"></i><span class="break"></span>Liste des Session</h2>
                                <div class="box-icon">
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align:middle;" class="center"><c:out value="${session.datefin}"></c:out> </td>
                                                    ...
                                                    <td style="vertical-align:middle;" class="center">
                                                        <a class="btn btn-success" href="ActionSessionServlet?id_event=zoom&id_s=<c:out value="${session.id}"></c:out>" >
                                                            <i class="halflings-icon white zoom-in"></i>  
                                                        </a>
                                                        <a class="btn btn-info" href="ActionSessionServlet?id_event=edit&id_s=<c:out value="${session.id}"></c:out>" >
