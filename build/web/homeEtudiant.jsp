                ...
                <div class="container-fluid">
                    ...
                    <div class="nav-no-collapse header-nav">
                        <ul class="nav pull-right">
                            ...
                            <li>
                                <a class="btn" href="FermerSessionServlet">
                    ...
                    <div class="row-fluid sortable">
                                        ...
                                        <c:forEach items="${requestScope.sessionList}" var="session">
                                            <tr>
                                               ...
                                               <td style="vertical-align:middle;" class="center">
                                                        <a class="btn btn-success" href="NoteEtudiant?id_s=<c:out value="${session.id}"></c:out>" >
                     ...
                     <div class="row-fluid sortable">
                        <div class="box span12">
                            ...
                            <div class="box-content">
                                 <c:if test="${requestScope.session.type == 'Principale'}"> 
                                <table class="table table-striped table-bordered bootstrap-datatable datatable" >
                                                <thead>
                                                    <tr>
                                                ...
                                                <c:forEach items="${requestScope.listN}" var="note">
                                                    <tr>
                                                        ...
                                                        <td style="vertical-align:middle;" class="center"><c:out value="${note.m.nom}"></c:out> </td>
                                ...
                                <c:if test="${requestScope.session.type == 'Controle'}"> 
                                <table class="table table-striped table-bordered bootstrap-datatable datatable" >
                                                <thead>
                                                    <tr>
